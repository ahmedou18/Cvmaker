...
<head>
    ...
    <title>تأكيد الدفع - CVmaker</title>
...
<body class="bg-gray-50 text-gray-800 min-h-screen flex items-center justify-center px-4 py-12">
    ...
    <div class="w-full max-w-2xl">
        <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 mb-6 transition group">
            ...
            <span class="font-bold">العودة للخطط</span>
        </a>

        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            <div class="gradient-bg text-white text-center py-10 px-6">
                <p class="text-blue-100 text-sm font-bold mb-2 uppercase tracking-widest">تفعيل اشتراك</p>
                ...
                <div class="inline-block bg-white/20 backdrop-blur-md rounded-2xl px-6 py-3">
                    ...
                    <span class="text-lg font-bold opacity-90">أوقية</span>
                </div>
            </div>

            <div class="p-8">
                <div class="bg-blue-50 rounded-2xl p-6 mb-8 border border-blue-100 text-center">
                    <p class="text-blue-800 font-bold mb-2 text-lg">الرقم الموحد للتحويل</p>
                    <div class="flex items-center justify-center gap-3">
                        <span class="text-4xl font-black text-blue-600 tracking-tighter">26121732</span>
                        <div class="bg-blue-600 text-white text-[10px] px-2 py-1 rounded-md uppercase font-bold">موحد</div>
                    </div>
                    <p class="text-blue-600/70 text-sm mt-2 font-semibold">أرسل المبلغ ثم ارفع صورة الوصل أدناه</p>
                </div>
                ...
                <form action="{{ route('payment.manual') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-4 text-center">اختر خدمة الدفع المستخدمة:</label>
                    ...
                    <div class="pt-4">
                        <label class="block text-sm font-bold text-gray-700 mb-3 uppercase tracking-wide">صورة إثبات التحويل (Screenshot)</label>
                        <div class="relative group">
                            ...
                            <div class="border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center group-hover:border-blue-400 transition-colors bg-gray-50">
                                ...
                                <p class="text-sm font-bold text-gray-600" id="file-name">اضغط هنا لرفع الصورة</p>
                                <p class="text-xs text-gray-400 mt-1">يُقبل JPG أو PNG (حد أقصى 2MB)</p>
                            </div>
                        </div>
                    </div>
        ...
        <p class="text-center text-gray-400 text-xs mt-8">
            بعد إرسال الطلب، سيقوم فريقنا بمراجعة التحويل وتفعيل باقتك خلال أقل من 15 دقيقة.
        </p>
    </div>
    ...
    <script>
        function updateFileName(input) {
            ...
            if (input.files && input.files[0]) {
                label.innerHTML = `<span class="text-green-600 font-bold">✓ تم اختيار: ${input.files[0].name}</span>`;
            }
        }
    </script>
</body>
